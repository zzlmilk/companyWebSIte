...
<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style>
            #ensure{
                background: none repeat scroll 0 0 #0B6DE8;
                color: #FFFFFF;
                cursor: pointer;
                display: block;
                font-size: 23px;
...
<div style="clear: both;"></div>
            <div id="lostpasswordEmail_div" style=" height: 340px;">
                <div style=" margin: 55px 0 0 60px;">
                    <div style=" color: #5C5857;font-size: 18px;letter-spacing: 1px;font-weight: bold;">Please enter your E-mail:</div>
                    <div style=" margin-top: 30px;">
                        <input type="text" name="lostemail" id="lostemail" class="textStyle" />             
                    </div>

                    <div style=" color: #5C5857;font-size: 18px; margin-top: 30px;letter-spacing: 1px;font-weight: bold;">Please set your E-mail:</div>
                    <div style=" margin-top: 30px;">
                        <input type="text" name="lostemail" id="lostemail" class="textStyle" />             
                    </div>

                    <div style="color:red; margin-top: 15px;">Password input error !</div>
                    <div id="ensure">Ensure</div>
                </div>
