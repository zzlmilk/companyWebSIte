            ...
            <div id="lostpasswordEmail_div" style=" height: 300px;">
                <div style=" margin: 55px 0 0 60px;">
                    ...
                    <div style=" margin-top: 30px;">
                        <input  type="text" name="lostemail" id="lostemail" style=" border: 1px solid black; border-left: 2px solid #B0B0B0; height: 41px; width: 535px; font-size: 17px; border-radius: 2px; -moz-border-radius: 2px; -webkit-border-radius: 2px; text-indent: 5px;" onkeyup="lostPasswordEmail()" />             
                    </div>
