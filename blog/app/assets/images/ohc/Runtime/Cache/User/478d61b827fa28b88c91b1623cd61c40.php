        ...
        <script>
            $(function() {
                ...
                $('#imgEmsure2').mousedown(function(){
                    $('#imgEmsure2').attr('src',WebsitePublic+'/image/Home/Index/ensure.jpg');
                })
                $('#imgEmsure2').mouseup(function(){
                    $('#imgEmsure2').attr('src',WebsitePublic+'/image/Home/Index/ensure2.jpg');
                })
                ...
                <div style=" margin: 55px 0 0 60px;">
                    <?php if($state == 1 ): ?>update password successly,please login
                        ...
                        <form action="<?php echo U('User/info/updatePassword');?>"  method="post" id="setpasswordform" name="setpasswordform" >
                            ...
                            <div style=" color: #5C5857;font-size: 18px;letter-spacing: 1px;font-weight: bold;">Please enter new password:</div>
                            <div style=" margin-top: 30px;">
                                <input type="text" name="lostpassword" id="lostpassword" class="textStyle" />             
                            </div>

                            <div style=" color: #5C5857;font-size: 18px; margin-top: 30px;letter-spacing: 1px;font-weight: bold;">Please set your password:</div>
                            <div style=" margin-top: 30px;">
                                <input type="text" name="relostpassword" id="relostpassword" class="textStyle" />             
                            </div>
